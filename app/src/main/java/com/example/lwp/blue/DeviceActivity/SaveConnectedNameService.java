 ...
 * helper methods.
 */
public class SaveConnectedNameService extends IntentService {
    ...
    public SaveConnectedNameService() {
        super("SaveConnectedNameService");
    }
    ...
    public static void startActionFoo(Context context, String param1, String param2) {
        Intent intent = new Intent(context, SaveConnectedNameService.class);
